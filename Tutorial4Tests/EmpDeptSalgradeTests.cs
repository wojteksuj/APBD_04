...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result = emps.Join(depts, e => e.DeptNo, dept => dept.DeptNo, (e, d) => (e.EName, d.DName)).ToList();
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps.Where(e => e.Comm.HasValue).Select(e =>  (e.EName, e.Comm )).ToList(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.SelectMany(e => grades,
                (e, s) => new { e.EName, e.Sal, s.Grade, s.Losal, s.Hisal })
